              ...
              <div className="hidden md:flex items-center space-x-4">
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 rounded-lg font-medium text-gray-600 hover:text-gray-500 hover:bg-gray-50 transition-all duration-200"
                  >
                    <Globe className="w-4 h-4" />
                    <span className="text-black-600 font-semibold">{language.toUpperCase()}</span>
                    ...
                    <div className="absolute top-full right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg py-1 min-w-[120px] z-50">
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 transition-colors ${
                          language === 'en' ? 'text-black-600 font-semibold bg-black-50' : 'text-gray-700'
                        }`}
                      >
                        <div className="flex items-center justify-between">
                          <span>EN</span>
                          {language === 'en' && <div className="w-2 h-2 bg-black-600 rounded-full"></div>}
                        </div>
                      </button>
                      <button
                        onClick={() => toggleLanguage('th')}
                        className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 transition-colors ${
                          language === 'th' ? 'text-black-600 font-semibold bg-black-50' : 'text-gray-700'
                        }`}
                      >
                        <div className="flex items-center justify-between">
                          <span>TH</span>
                          {language === 'th' && <div className="w-2 h-2 bg-black-600 rounded-full"></div>}
                        </div>
                      </button>
                    </div>
                  )}
